...
import { ChevronDown, ChevronRight, Divide, LucideIcon, Plus, MoreHorizontal, Trash} from 'lucide-react'
...
function Item({id, label, onClick, icon:Icon, documentIcon, active, expanded, isSearch, level=0, onExpand}:ItemProps) {
    const {user} = useUser()
