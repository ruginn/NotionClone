        ...
        <DropdownMenuTrigger asChild>
            <div role='button' className="flex items-center text-sm p-3 w-full hover:bg-primary/5">
                <div className="gap-x-2 flex items-center max-w-[150px]">
                    ...
                    <span className="text-start font-medium line-clamp-1">{user?.fullName}&apos;s Hotion</span>
                </div>
        ...
        <DropdownMenuContent className="w-80" align='start' alignOffset={11} forceMount>
            <div className="flex flex-col space-y-4 p-2">
                ...
                <div className="flex items-center gap-x-2">
                    <div className="rounded-full bg-secondary p-1 h-8 w-8"> 
                        <Avatar className="h-2 w-2">
                            <AvatarImage className='rounded-full' src={user?.imageUrl} />
                        </Avatar>
                    </div>
                    <div className="space-y-1">
                        <p className="text-sm line-clamp-1">{user?.fullName}&apos;s Hotion</p>
                    </div>
                </div>
            </div>
